                                    ...
                                    {({getRootProps, getInputProps}) => (
                                        <section>
                                            <div {...getRootProps()}>
                                                ...
                                                <input {...getInputProps()} />
                                                <p className="text-center"><span className="text-danger">DropZone</span> <span className="mx-">Drop files here to upload</span> </p>
                                            </div>
                                        </section>
                                    )}
                                </Dropzone>
                                            ...
                                            <div className="row" key={index}>
                                                ...
                                                <div className="col-md-8">
                                                    <div className="form-group">
                                                        ...
                                                        <section id="selectvariant" multiple style={{marginTop: "30px"}}>
                                            ...
                                            productVariantPrices.map((productVariantPrice, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td><input placeholder='0'  className="form-control" type="text"/>{productVariantPrice.price}</td>
                                                        <td><input placeholder='0' className="form-control" type="text"/>{productVariantPrice.stock}</td>
                                                    </tr>
                                                )
                                            })
                                        }
